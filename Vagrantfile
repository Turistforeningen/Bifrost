...
NTB_API_KEY=`cat /vagrant/env/NTB_API_KEY`
SH2_API_KEY=`cat /vagrant/env/SH2_API_KEY`
SH2_PG_CON=`cat /vagrant/env/SH2_PG_CON`
SENTRY_DNS=`cat /vagrant/env/SENTRY_DNS`
